...
$(document).ready(function() {
    $("#btnChangePass").click(function() {
        ...
        if (Cnt == 0) {
            ...
            $.ajax({
                url: "../Controllers/AdminController.php?Choice=updatePasswd",
                type: "POST",
            ...
            <div class="modal" id="AdminProfileModel">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="txtProfileFullName"
                                                id="txtProfileFullName">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <b>User Name</b><span class='error' id='lblProfileUserName'></span>
                                            <input type="text" class="form-control" name="txtProfileUserName"
                                                id="txtProfileUserName">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <b>Contact No</b><span class='error' id='lblProfileCno'></span>
                                            <input type="text" class="form-control" name="txtProfileCno"
                                                id="txtProfileCno">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <b>Email</b><span class='error' id='lblProfileEmail'></span>
                                            <input type="text" class="form-control" name="txtProfileEmail"
                                                id="txtProfileEmail">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-dark" id="btnChangeProfile">ADD</button>
...
async function insertDate() {
    ...
    $.ajax({
        url: "../Controllers/AdminController.php?Choice=UpdateAdminDetail",
        type: "POST",
        contentType: "app/json",
        data: JSON.stringify(JsonData),
        success: function(res) {
            alert(res);
            setCookie("AdminFullName", $("#txtProfileFullName").val());
