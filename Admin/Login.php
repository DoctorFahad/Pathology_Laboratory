...
<body>
    ...
    $(document).ready(function() {
        ...
        $("#btnSignIn").click(function() {
            ...
            if (Cnt == 0) {
                $.ajax({
                    url: "../Controllers/AdminController.php?Choice=Authentication",
                    type: "POST",
                    ...
                    success: function(res) {
                        if (res.trim() != "Fail") {
                            res = JSON.parse(res);
                            setCookie('AdminFullName', res.FullName, 30);
                            setCookie('AdminId', res.AdminId, 30);
...
<script>
    $(document).ready(function(){
        $("#btnforgotPasswd").click(function(){
            ...
            {
                $.ajax({
                    url: "../Controllers/AdminController.php?Choice=forgotPasswd",
                    type: "POST",
                    contentType: "app/json",
                    data: JSON.stringify({
                        "Email": $("#txtEmail").val()
