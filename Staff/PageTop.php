...
<head>
    ...
    <!-- Title -->
    <title>Staff-Precision Lab Solutions</title>
    <!-- Favicon -->
                    ...
                    <div class="side-menu-area">
                        <nav>
                            <ul class="sidebar-menu" data-widget="tree">
                                <li><a href="Patient.php"><span style='font-family: Times New Roman'>Home</span></a></li>
                                <li class="treeview">
                                    <a href="javascript:void(0)"><span style='font-family: Times New Roman'>Receipt</span></a>
                                    <ul class="treeview-menu">
                                        <li><a href="Receipt.php"><span style='font-family: Times New Roman'>Create Receipt</span></a></li>
                                        <li><a href="ReceiptList.php"><span style='font-family: Times New Roman'>Receipt List</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu profile dropdown-menu-right">
                                ...
                                <div class="user-profile-area">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#StaffProfileModel"
                                     class=" dropdown-item"><i class="bx bx-user font-15" aria-hidden="true"></i>Change
                                        profile</a>
                                    <a data-bs-toggle="modal" data-bs-target="#ChangePassword" class="dropdown-item"><i class="bx bx-wrench font-15"
                ...
                $(document).ready(function() {
                    $("#logout").click(function() {
                        ...
                        if (confirm("Are you sure want to logout")) {
                            deleteCookie("StaffFullName");
                            deleteCookie("StaffId");
                            window.location.href = "Login.php";
                        }
                    });

                    $("#lblProfile").html(getCookie("StaffFullName"));
